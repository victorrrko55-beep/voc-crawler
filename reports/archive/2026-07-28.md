...
- 발생 빈도: 43건 (최근 3개월 25건 / 이전 9개월 18건)
- 증가율: +317%
...
- Pain Point 요약: 최근 3개월 발생 빈도가 이전 대비 +317% 증가하며, 'Multi-brand Integration' 관련 부정 VOC가 총 43건 누적되어 상위 Pain Point로 식별됨.
...
- **Multi-brand Integration**: 최근 6개월 36건 vs 이전 6개월 7건 (+317%)
...
**Connectivity & Reliability** — 최근 3개월 80건(+823%), 12개월 누적 106건으로 전체 부정 VOC의 41%를 차지, 2위(Multi-brand Integration, 최근 3개월 25건)보다 55건 더 많음.
...
- 최근 12개월간 SmartThings 앱 관련 부정 VOC 261건을 분석한 결과, 가장 시급한 Pain Point는 "Connectivity & Reliability"이며 최근 3개월 발생 빈도가 80건(+823%)으로 나타났다.

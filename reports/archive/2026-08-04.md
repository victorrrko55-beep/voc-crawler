...
- 발생 빈도: 120건 (최근 3개월 89건 / 이전 9개월 31건)
- 증가율: +761%
- 대표 VOC: "The device keeps going offline. I am on my way to spend 3 days away from home and can't turn the AC off because the app or the device aren't working as they should. I DO NOT RECOMMEND update: August 2026: still I rate it…" — play, 2026-08-03 ([원문](https://play.google.com/store/apps/details?id=com.samsung.android.oneconnect))
- Pain Point 요약: 최근 3개월 발생 빈도가 이전 대비 +761% 증가하며, 'Connectivity & Reliability' 관련 부정 VOC가 총 120건 누적되어 상위 Pain Point로 식별됨.
...
- 발생 빈도: 48건 (최근 3개월 28건 / 이전 9개월 20건)
- 증가율: +320%
- 대표 VOC: "Meross ms605 matter sensor ...here's a FAQ: https://www.meross.com/en-gc/mTerminal/smart-home-security/Smart-Presence-Sensor-Thread/212 At the end it's just as good or bad as any battery powered mmWave sensor. My Aqara F…" — smartthings_community, 2026-07-30 ([원문](https://community.smartthings.com/t/meross-ms605-matter-sensor/309123/13))
- Pain Point 요약: 최근 3개월 발생 빈도가 이전 대비 +320% 증가하며, 'Multi-brand Integration' 관련 부정 VOC가 총 48건 누적되어 상위 Pain Point로 식별됨.
...
- 순위: 3
- 카테고리: Performance
- 발생 빈도: 39건 (최근 3개월 29건 / 이전 9개월 10건)
- 증가율: +770%
- 대표 VOC: "Android mobile app crashes when opened Any suggestion how to restore SmartThings setup? Due to this incident, all my setup is lost… no home, no location, no hub, no device, no rooms…" — smartthings_community, 2026-08-04 ([원문](https://community.smartthings.com/t/android-mobile-app-crashes-when-opened/310501/40))
- Pain Point 요약: 최근 3개월 발생 빈도가 이전 대비 +770% 증가하며, 'Performance' 관련 부정 VOC가 총 39건 누적되어 상위 Pain Point로 식별됨.
...
- 발생 빈도: 35건 (최근 3개월 22건 / 이전 9개월 13건)
- 증가율: +408%
- 대표 VOC: "Im having a problem to turn on my Samsung Smart TV ...wever when I run the automation more than 20 seconds after turning the TV OFF, it fails at the " Media player: Turn on media player" stage with error SmartThingsComma…" — other_forum_home_assistant, 2026-08-01 ([원문](https://community.home-assistant.io/t/im-having-a-problem-to-turn-on-my-samsung-smart-tv/588054/25))
- Pain Point 요약: 최근 3개월 발생 빈도가 이전 대비 +408% 증가하며, 'Automation & Routine' 관련 부정 VOC가 총 35건 누적되어 상위 Pain Point로 식별됨.
...
- 증가율: 신규
- 대표 VOC: "Started sending me advertisements via push notification. 1 star. The app is terrible as well but sending me ads via push notification is what prompted this review." — play, 2026-07-31 ([원문](https://play.google.com/store/apps/details?id=com.samsung.android.oneconnect))
- Pain Point 요약: 최근 3개월 내 새롭게 부각된 이슈로, 'Notification & Alert' 관련 부정 VOC가 총 2건 누적되어 상위 Pain Point로 식별됨.
...
- 발생 빈도: 2건 (최근 3개월 2건 / 이전 9개월 0건)
- 증가율: 신규
- 대표 VOC: "Bixby Alerts are annoying! I cannot get the Bixby alerts to stop on our appliances, requesting to activate the appliances. It’s nonstop." — appstore, 2026-07-24 ([원문](https://apps.apple.com/us/app/id1222822904))
- Pain Point 요약: 최근 3개월 내 새롭게 부각된 이슈로, 'AI / Voice' 관련 부정 VOC가 총 2건 누적되어 상위 Pain Point로 식별됨.
...
- **Connectivity & Reliability**: 최근 6개월 104건 vs 이전 6개월 16건 (+761%)
...
**Connectivity & Reliability** — 최근 3개월 89건(+761%), 12개월 누적 120건으로 전체 부정 VOC의 41%를 차지, 2위(Multi-brand Integration, 최근 3개월 28건)보다 61건 더 많음.

Root Cause 추정: 허브-클라우드 간 세션 유지 로직 취약, 다중 홉 메시 네트워크에서의 신호 간섭, 백그라운드 재연결 로직 미흡으로 오프라인 표시가 실제 상태와 어긋남.

### 사용자 이탈 위험 요소

대체 솔루션으로의 전환·삭제 의사를 직접 언급한 VOC 1건 확인. 건수는 많지 않지만 자발적 이탈 의사 표현은 일반 불만보다 드물게 나타나는 강한 신호이므로 주시가 필요합니다. 주로 **Connectivity & Reliability** 관련 맥락에서 언급됨.
...
Aqara, Apple Home, Google Home 등 경쟁/대체 플랫폼과 비교하며 SmartThings의 열위를 지적한 VOC 5건 확인. 주로 **Multi-brand Integration** 카테고리에서 함께 언급됨.
...
- "[ST Edge] Aqara FP300 (Zigbee) So i setup the fp300 and im disappointed. I couldnt update the device becasue i dont have an aqara hub and i think its slower det…" — smartthings_community, 2026-06-29 ([원문](https://community.smartthings.com/t/st-edge-aqara-fp300-zigbee/306507/78))
...
3. **Security & Privacy** (+800%) — 권한 요청 시점과 사유 설명이 불충분해 사용자가 과도한 권한 요구로 인식, 보안 관련 정책 변경 공지가 앱 내에서 충분히 전달되지 않음.
...
- 차기 릴리즈에서는 Notification & Alert, AI / Voice, Security & Privacy 항목을 우선 검토 대상으로 제안한다.
